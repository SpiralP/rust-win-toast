...
sourcesIndex["libc"] = {"name":"","dirs":[{"name":"windows","dirs":[{"name":"msvc","dirs":[{"name":"x86_64","files":["align.rs","mod.rs"]}],"files":["mod.rs"]}],"files":["mod.rs"]}],"files":["fixed_width_ints.rs","lib.rs","macros.rs"]};
...
sourcesIndex["widestring"] = {"name":"","dirs":[{"name":"platform","files":["mod.rs","windows.rs"]}],"files":["error.rs","iter.rs","lib.rs","ucstr.rs","ucstring.rs","ustr.rs","ustring.rs"]};
sourcesIndex["win_toast"] = {"name":"","files":["lib.rs"]};
sourcesIndex["win_toast_sys"] = {"name":"","files":["bindings.rs","lib.rs"]};
createSourceSidebar();
